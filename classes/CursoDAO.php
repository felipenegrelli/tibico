...
class CursoDAO extends DB implements IDAO {
	...
	public function insert($curso) {
		$sql = "INSERT INTO cursos (nome, regime, duracao, sigla, descricao, area_conhecimento, grau_instrucao) VALUES (:nome, :regime, :duracao, :sigla, :descricao, :area_conhecimento, :grau_instrucao)";
	    $stmt = DB::prepare($sql);
